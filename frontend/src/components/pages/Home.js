      ...
      {isLoading ? (
        ...
        <div>
          <div id="nav-bar">
            ...
            <div id="nav-items">
              <img src={home} alt="home" onClick={() => setContent('home')} />
              <img
                src={movies}
                alt="movies"
                onClick={() => setContent('movies')}
              />
              <img src={tv} alt="tv" onClick={() => setContent('tv')} />
              <img
                src={bookmarks}
                alt="bookmarks"
          ...
          {/* main content */}
          {content === 'movies' ? (
            <Movies moviesAndShows={moviesAndShows} searchTerm={searchTerm} />
          ) : content === 'tv' ? (
            <TVShows moviesAndShows={moviesAndShows} searchTerm={searchTerm} />
          ) : content === 'bookmarked' ? (
            <Bookmarked
              ...
              <div>
                ...
                <div id="scrolling-container">
                  {moviesAndShows.map(
                    (trending, idx) =>
                      trending.isTrending && (
                        <ThumbnailLarge trending={trending} key={idx} />
                      )
                  )}
                </div>
              </div>
              <div>
                <h1 id="recommended-title">Recommended for you</h1>
                <div id="main-content">
                  {moviesAndShows
                    .filter((result) => {
